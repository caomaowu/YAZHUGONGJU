...
- **AI 助手（沉浸式对话）**: 内置“压铸工艺专家”对话页，支持流式输出/停止生成、Markdown + LaTeX 渲染、代码块高亮与复制、Token 统计
- **OpenAI 协议兼容**: 支持配置兼容 OpenAI 协议的 Base URL / API Key / 默认模型，并将配置与会话持久化到本地 JSON
